...
const v2AssertionTypes: Array<{ value: SuiteAssertion['type']; label: string }> = [...assertionTypes, { value: 'tool', label: 'Tool invocation' }];
...
export function SuitesPage({ suites, servers, providers, onRefresh, onRunStarted }: {
  ...
  const renderCaseEditor = () => {
    ...
    const availableAssertionTypes = draft.version === 2 ? v2AssertionTypes : assertionTypes;
